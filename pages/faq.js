...
function FaqMain(){
	return(
        ...
        <h4> What is Generative lottery? </h4>
        <p>Generative lottery is an NFT based lottery smart contract where each NFT you buy will act as a lottery ticket. Once all 10k NFTs are sold 10 lucky winners will be selected at random & the prize pool is distributed to them automatically.</p>
